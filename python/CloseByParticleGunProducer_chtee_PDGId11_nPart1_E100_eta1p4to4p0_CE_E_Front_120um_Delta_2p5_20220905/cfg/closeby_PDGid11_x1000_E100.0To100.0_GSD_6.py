...
# random seeds
process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(6)
process.RandomNumberGeneratorService.VtxSmeared.initialSeed = cms.untracked.uint32(6)
process.RandomNumberGeneratorService.mix.initialSeed = cms.untracked.uint32(6)

# Input source
process.source.firstLuminosityBlock = cms.untracked.uint32(6)

# Output definition
process.FEVTDEBUGHLToutput.fileName = cms.untracked.string('file:closeby_PDGid11_x1000_E100.0To100.0_GSD_6.root')
