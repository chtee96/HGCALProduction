...
# random seeds
process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(9)
process.RandomNumberGeneratorService.VtxSmeared.initialSeed = cms.untracked.uint32(9)
process.RandomNumberGeneratorService.mix.initialSeed = cms.untracked.uint32(9)

# Input source
process.source.firstLuminosityBlock = cms.untracked.uint32(9)

# Output definition
process.FEVTDEBUGHLToutput.fileName = cms.untracked.string('file:closeby_PDGid11_x1000_E100.0To100.0_GSD_9.root')
