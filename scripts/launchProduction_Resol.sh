...
then
  ...
  do
      ...
      echo python production_withdeltas.py --datTier NTUP --evtsperjob 100 --queue tomorrow --partID 11 --nPart 1 --eosArea /eos/user/c/chtee/CalibrationStudies --gunMode closeby --date ${thedate} --tag $i
      python production_withdeltas.py --datTier NTUP --evtsperjob 100 --queue tomorrow --partID 11 --nPart 1 --eosArea /eos/user/c/chtee/CalibrationStudies --gunMode closeby --date ${thedate} --tag $i
  done
